...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/multimethod-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9665&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/multimethod-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `multimethod` can be installed with:

```
conda install multimethod
```

It is possible to list all of the versions of `multimethod` available on your platform with:
